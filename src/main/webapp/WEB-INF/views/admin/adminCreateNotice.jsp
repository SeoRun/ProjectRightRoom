...
<jsp:include page="../include/header.jsp" />
	...
	<form action="<c:url value='/admin/registerNoticeConfirm' />" id="noticeForm" name="adminCreateNotice" method="post" enctype="multipart/form-data">
		<div class="container">
			<h2>게시글을 작성해 주세요.</h2>
			...
			<div class="input-box">
				<input type="text" id="title" name="n_u_title" placeholder="제목을 입력해 주세요.">
			</div>
	
			<div class="input-box">
				<textarea id="content" rows="10" name="n_u_content" placeholder="내용을 입력해 주세요."></textarea>
			</div>
			...
			<div class="buttons">
				...
				<input type="button" id="register" value="등록" onclick="registerNotice()">
			</div>
		</div>
	</form>
	...
	<script>
		...
		function registerNotice() {
		    let form = document.getElementById("noticeForm");
